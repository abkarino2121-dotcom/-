...
const Table = React.forwardRef(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto font-['Tajawal']">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm rtl:text-right", className)}
      {...props}
    />
  </div>
))
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-slate-500 font-semibold align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
